        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="col-xs-11 col-xs-offset-1">
                ...
                <input type="radio" name="genre" value="M"
                    <?php if (isset($genre) && $genre=="M") echo "checked";?>
                > M.
                <input type="radio" name="genre" value="Mme"
                    <?php if (isset($genre) && $genre=="Mme") echo "checked";?>
                > Mme.
            ...
            <div class="col-xs-11 col-xs-offset-1">
                ...
                <input type="text" name="birthdate" placeholder="jj/mm/yyyy" value="<?php echo $birthdate;?>">
                <span class="error">* <?php echo $birthdateErr;?></span>
            </div>
            <div class="col-xs-11 col-xs-offset-1">
                <label>Cosplayer</label><br/>
                <input type="radio" name="cosplay" value="oui"
                    <?php if (isset($cosplay) && $cosplay=="oui") echo "checked";?>
                > Oui
                <input type="radio" name="cosplay" value="non"
                    <?php if (isset($cosplay) && $cosplay=="non") echo "checked";?>
                > Non
